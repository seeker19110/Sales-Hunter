...
Luồng chuẩn: **đặc tả → nhánh/worktree → TDD → PR → CI/review → squash merge → quan sát**.
...
- Thân PR nêu mục tiêu, phạm vi, ADR/schema liên quan, test đỏ/xanh, bằng chứng manual/read-back và phần chưa kiểm.
